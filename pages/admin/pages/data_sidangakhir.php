    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Sidang Akhir Mahasiswa</li>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="data_sidangakhir.php">
          ...
          </div><div class="col-xl-3 col-sm-6 mb-3"></div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              ...
              <a class="card-footer text-white clearfix small z-1" href="data_sempro.php">
                <span class="float-left">Cek</span>
                <span class="float-right">
                  <i class="fas fa-angle-right"></i>
                </span>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <!-- Data Table -->
                  <?php
                  $query = "SELECT id_ta, idx, nim, nama, ruang, datetime, acc_status, nilai from ta, mahasiswa, jadwal WHERE id_mhs=nim AND id_jadwal=id_ta AND jenis_jadwal='sidang';";
                  ...
                  while ($row = mysqli_fetch_array($result))
                  {
                      ...
                      <tr>
                          ...
                          <!-- Button -->
                          <td><a href='../edit_sidang.php?idx=<?php echo $row['idx']; ?>&nim=<?php echo $row['nim']; ?>&nama_mhs=<?php echo $row['nama']; ?>&datetime=<?php echo $row['datetime']; ?>&ruang=<?php echo $row['ruang']; ?>&status=<?php echo $row['acc_status']; ?>&nama_dosbing=<?php echo $row[3]; ?>&id_dosbing=<?php echo $row['id_dosbing']?>&nilai=<?php echo $row['nilai']; ?>&id_ta=<?php echo $row['id_ta'];?>' class='btn btn-success'>
                                  <span class='glyphicon glyphicon-edit'></span>Edit</button></a>
                              <a href='../aksi_edit_sidang.php?idx=<?php echo $row['idx']; ?>&id_ta=<?php echo $row['id_ta']; ?>&aksi=delete' class='btn btn-danger'>
