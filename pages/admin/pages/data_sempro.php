    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Data Seminar Proposal</li>
        </ol>
          <?php
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <!-- Data Table -->
                  <?php
                          $query = "SELECT idx, nim, mahasiswa.nama, dosen.nama, ruang, datetime, acc_status, id_dosbing from ta, mahasiswa, jadwal, dosen WHERE id_mhs=nim AND id_jadwal=id_ta AND jenis_jadwal='sempro' and id_dosuji = nidn;";
                  ...
                  <tr>
                      ...
                      <!-- Button -->
                          <td><a href='../edit_sempro.php?idx=<?php echo $row['idx']; ?>&nim=<?php echo $row['nim']; ?>&nama_mhs=<?php echo $row[2]; ?>&datetime=<?php echo $row['datetime']; ?>&ruang=<?php echo $row['ruang']; ?>&status=<?php echo $row['acc_status']; ?>&nama_dosbing=<?php echo $row[3]; ?>&id_dosbing=<?php echo $row['id_dosbing']?>' class='btn btn-success'>
                                  <span class='glyphicon glyphicon-edit'></span>Edit</button></a>
                              <a href='../aksi_edit_sempro.php?idx=<?php echo $row['idx']; ?>&nim=<?php echo $row['nim']; ?>&aksi=delete' class='btn btn-danger'>
